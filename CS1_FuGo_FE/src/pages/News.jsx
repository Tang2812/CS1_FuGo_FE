                    ...
                    <div className="news-grid">
                        <div className="news-column">
                            ...
                            <article className="news-item">
                                <img
                                    src="/src/img/new_back/new_back_1.png"
                                    alt="News image"
                                    className="news-item__img"
                                />
                                <div className="news__content">
                                    <h3>
                                        <a href="/news-detail">3 Điều Cha Mẹ Bắt Buộc Ghi Nhớ Khi Có Con Đang Học Trung
                                            Học Phổ
                                            Thông</a>
                                    </h3>
                            ...
                            <article className="news-item">
                                <img
                                    src="/src/img/new_back/new_back_2.png"
                                    alt="News image"
                                    className="news-item__img"
                                />
                                <div className="news__content">
                            ...
                            <article className="news-item">
                                <img
                                    src="/src/img/new_back/new_back_3.png"
                                    alt="News image"
                                    className="news-item__img"
                                />
                                <div className="news__content">
