            ...
            <div className="container">
                <div className="form-section">
                    ...
                    <form className="form-dang-ky">
                        <p>Chọn vai trò bạn muốn đăng ký <span
                            className='font-semibold'>(bắt buộc)</span></p>
                        <div className="role-buttons">
                            ...
                            <button
                                className={`role-button ${role === 'partner' ? 'active' : ''} hover:bg-[#2196f3] hover:text-white`}
                                onClick={() => handleRole('partner')}
                            >Nhà tuyển dụng
                            </button>
                        </div>
                        <input type="text" placeholder="Tên đăng nhập" required id="username"
                               onChange={(e) => setUsername(e.target.value)}/>
                        <input type="email" placeholder="Email" required id="email"
                               onChange={(e) => setEmail(e.target.value)}/>
                        <input type="password" placeholder="Mật khẩu" required id="password"
                               onChange={(e) => setPassword(e.target.value)}/>
                        <input type="password" placeholder="Nhập lại mật khẩu" required id="confirmPassword"
